...
def display_about():
    ...
    with col1:
        ...
        img.close()
        st.markdown(
            f'<img src="data:image/png;base64,{base64_img}" style="border-radius: 10%; width: 100px; height: 100px; margin: 0 auto;"><p style="margin-bottom: 20px;"></p>',
    ...
    with col4:
        ...
        st.write("""
            **Anasstasya Pangaribuan** """)
        

    with col5:
        img = open("assets/Umar.png", "rb")
        base64_img = base64.b64encode(img.read()).decode()
        img.close()
        st.markdown(
            f'<img src="data:image/png;base64,{base64_img}" style="border-radius: 10%; width: 100px; height: 100px;"><p style="margin-bottom: 20px;"></p>',
            unsafe_allow_html=True,
        )
        st.write("""
            **Umar Sayyid** """)
